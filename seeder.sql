...
# seed posts
insert into posts (title, description, post_details_id) values
('post 1', 'This is the test post 1 description', 1),
('post 2', 'This is the test post 2 description', 2),
('post 3', 'This is the test post 3 description', 3),
('post 4', 'This is the test post 4 description', 4),
('post 5', 'This is the test post 4 description', 5);
